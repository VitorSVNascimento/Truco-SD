...
const protocol_buffers_schema_1 = require("protocol-buffers-schema");
...
function validate(input) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            (0, protoj2jsonSchema_1.protoj2jsonSchema)((0, protocol_buffers_schema_1.parse)(payload), {
                getOne: true,
            });
            // No errors found.
            return [];
...
function parse(input) {
    return __awaiter(this, void 0, void 0, function* () {
        const payload = input.data;
        return (0, protoj2jsonSchema_1.protoj2jsonSchema)((0, protocol_buffers_schema_1.parse)(payload), {
            getOne: true,
        });
    });
}
